...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        [SerializeField] private WheelCollider[] m_WheelColliders = new WheelCollider[4]; // check wheel position in TractionControl()
        ...
        public float CurrentSpeed { get { return m_Rigidbody.velocity.magnitude * 2.23693629f; } } // 1 meter per second = 2.23693629 miles per hour
